...
export default function SignInModal() {
  ...
  return (
    <div onClick={() => { setShowSignInModal(false); setPendingAction(null); }} style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.8)", backdropFilter: "blur(8px)" }}>
      <div onClick={(e) => e.stopPropagation()} style={{ background: "#111113", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "16px", padding: "40px 32px", maxWidth: "400px", width: "90%", textAlign: "center" }}>
        ...
        {error && (<div style={{ background: "rgba(255,60,30,0.1)", border: "1px solid rgba(255,60,30,0.2)", borderRadius: "10px", padding: "10px 14px", marginBottom: "16px", fontSize: "13px", color: "#ff6b35" }}>{error}</div>)}
        <button onClick={handleSignIn} disabled={loading} style={{ width: "100%", padding: "12px", borderRadius: "10px", background: loading ? "rgba(255,255,255,0.8)" : "#fff", color: "#111", border: "none", fontSize: "14px", fontWeight: 500, fontFamily: "'DM Sans', sans-serif", cursor: loading ? "wait" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", opacity: loading ? 0.7 : 1 }}>
